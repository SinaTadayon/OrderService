...
//}
//
//func NewItemRepository(config *configs.Cfg) (IItemRepository, error) {
//
//	// store in mongo
...
//}
//
//func (repo iItemRepositoryImpl) Save(order entities.Order) (*entities.Order, error) {
//
...
//}
//
//func (repo iItemRepositoryImpl) SaveAll(orders []entities.Order) ([]*entities.Order, error) {
//	panic("implementation required")
//}
//
//func (repo iItemRepositoryImpl) Insert(order entities.Order) (*entities.Order, error) {
//	if len(order.OrderId) == 0 {
//		order.OrderId = entities.GenerateOrderId()
//	}
//
...
//}
//
//func (repo iItemRepositoryImpl) InsertAll(entities []entities.Order) ([]*entities.Order, error) {
//	panic("implementation required")
//}
//
//func (repo iItemRepositoryImpl) FindAll() ([]*entities.Order, error) {
...
//}
//
//func (repo iItemRepositoryImpl) FindAllWithSort(fieldName string, direction int) ([]*entities.Order, error) {
//	total, err := repo.Count()
//	if err != nil {
//		total = 128
//	}
...
//}
//
//func (repo iItemRepositoryImpl) FindAllWithPage(page, perPage int64) ([]*entities.Order, int64, error) {
//	if page < 0 || perPage == 0 {
...
//}
//
//func (repo iItemRepositoryImpl) FindAllWithPageAndSort(page, perPage int64, fieldName string, direction int) ([]*entities.Order, int64, error) {
//	if page < 0 || perPage == 0 {
//		return nil, 0, errors.New("neither offset nor start can be zero")
//	}
//
...
//}
//
//func (repo iItemRepositoryImpl) FindAllById(ids ...string) ([]*entities.Order, error) {
//	panic("implementation required")
//}
//
//func (repo iItemRepositoryImpl) FindById(orderId string) (*entities.Order, error) {
//	var order entities.Order
...
//}
//
//func (repo iItemRepositoryImpl) FindByFilter(supplier func() interface{}) ([]*entities.Order, error) {
//	filter := supplier()
...
//}
//
//func (repo iItemRepositoryImpl) FindByFilterWithSort(supplier func() (interface{}, string, int)) ([]*entities.Order, error) {
...
//}
//
//func (repo iItemRepositoryImpl) FindByFilterWithPage(supplier func() interface{}, page, perPage int64) ([]*entities.Order, int64, error) {
//	if page < 0 || perPage == 0 {
//		return nil, 0, errors.New("neither offset nor start can be zero")
//	}
//
...
//}
//
//func (repo iItemRepositoryImpl) FindByFilterWithPageAndSort(supplier func() (interface{}, string, int), page, perPage int64) ([]*entities.Order, int64, error) {
//	if page < 0 || perPage == 0 {
//		return nil, 0, errors.New("neither offset nor start can be zero")
//	}
//
...
//}
//
//func (repo iItemRepositoryImpl) ExistsById(orderId string) (bool, error) {
//	singleResult := repo.mongoAdapter.FindOne(databaseName, collectionName, bson.D{{"orderId", orderId},{"deletedAt", nil}})
//	if err := singleResult.Err(); err != nil {
...
//}
//
//func (repo iItemRepositoryImpl) DeleteById(orderId string) (*entities.Order, error) {
//	var err error
...
//}
//
//func (repo iItemRepositoryImpl) Delete(order entities.Order) (*entities.Order, error) {
//	return repo.DeleteById(order.OrderId)
//}
//
//func (repo iItemRepositoryImpl) DeleteAllWithOrders([]entities.Order) error {
//	panic("implementation required")
//}
//
...
//}
//
//func (repo iItemRepositoryImpl) Remove(order entities.Order) error {
//	return repo.RemoveById(order.OrderId)
//}
//
//func (repo iItemRepositoryImpl) RemoveAllWithOrders([]entities.Order) error {
//	panic("implementation required")
//}
//
