...
//func (shipmentRejectedBySeller canceledByBuyerState) ProcessOrder(ctx context.Context, order entities.Order, itemsId []uint64, param interface{}) future.IFuture {
//
...
//}
//
//func (shipmentRejectedBySeller canceledByBuyerState) persistOrder(ctx context.Context, order *entities.Order) error {
...
//}
//
//func (shipmentRejectedBySeller canceledByBuyerState) updateOrderItemsProgress(ctx context.Context, order *entities.Order, itemsId []uint64, action string, result bool, itemStatus string) {
//
//	findFlag := false
...
//}
//
//func (shipmentRejectedBySeller canceledByBuyerState) doUpdateOrderItemsProgress(ctx context.Context, order *entities.Order, index int,
