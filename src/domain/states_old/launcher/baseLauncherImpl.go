...
func NewBaseLauncher(name string, index int, childes, parents []states_old.IState,
...
func (launcher *BaseLauncherImpl) SetChildes(states []states_old.IState) {
	launcher.childes = states
}

func (launcher *BaseLauncherImpl) SetParents(states []states_old.IState) {
...
func (launcher BaseLauncherImpl) Childes() []states_old.IState {
	return launcher.childes
}

func (launcher BaseLauncherImpl) Parents() []states_old.IState {
