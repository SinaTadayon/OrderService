...
func (returnShipmentDetailDelayed returnShipmentDetailDelayedStep) ProcessMessage(ctx context.Context, request *message.Request) promise.IPromise {
	panic("implementation required")
}

func (returnShipmentDetailDelayed returnShipmentDetailDelayedStep) ProcessOrder(ctx context.Context, order entities.Order) promise.IPromise {
	panic("implementation required")
}
